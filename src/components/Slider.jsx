...
export default function Slider({ draggable = false, children, slidesVisibles = 1, slidesToScrool = 1  }) {
  ...
  return (
    <div className='slider'>
      <div ref={containerRef} drag='x' dragConstraints={{ right: 0, left: -(slidesContainerPixelsWidth - slidePixelsWidth)}} className="flex slides-container" style={{ width: slidesContainerWidth + '%', transform: `translateX(-${slideWidth * index}%)` }}>
      ...
      <div className="controls">
        <button onClick={prev} className='prev'><FaAngleLeft /></button>
